...
trajectory stays inside this corridor from approach to pass completion.
The change from $\Delta s_{\rm E}>0$ at Encounter to
$\Delta s_{\rm P}<0$ at Pass records the longitudinal order reversal, while
$|\Delta n_{\rm E}|$ and $|\Delta n_{\rm P}|$ give the corresponding lateral
separations. The actual speed follows the desired profile and exceeds
70~m~s$^{-1}$ during the pass.
...
\caption{Tactical, spatial, and speed evolution in Case~I. (a) The FSM
progresses from \textsc{Raceline} through \textsc{Shadow} to the committed
\textsc{Overtake} mode. (b) The actual ego trajectory remains inside the
published feasible corridor, which lies within the physical track boundaries.
Triangles and squares mark the Encounter and Pass events, respectively. With
$\Delta s=s_o-s_e$ and $\Delta n=n_o-n_e$, $\Delta s_{\rm E}$ and
$|\Delta n_{\rm E}|$ denote the signed longitudinal and absolute lateral
separations at Encounter, while $\Delta s_{\rm P}$ and
$|\Delta n_{\rm P}|$ denote those at Pass. The change from
$\Delta s_{\rm E}>0$ to $\Delta s_{\rm P}<0$ identifies the completed
overtake. (c) The actual speed tracks the desired profile and exceeds
70~m~s$^{-1}$ during the pass.}
...
Lateral, speed, and heading errors remain close to zero, with brief transients
during the tactical transition. (d) All recorded tangential--normal
acceleration samples remain inside the speed-dependent tire envelope.}
...
corners. The change from $\Delta s_{\rm E}>0$ at Encounter to
$\Delta s_{\rm P}<0$ at Pass records the longitudinal order reversal, while
$|\Delta n_{\rm E}|$ and $|\Delta n_{\rm P}|$ give the corresponding lateral
separations. From an entry speed above 60~m~s$^{-1}$, the actual speed follows
the desired braking and re-acceleration profile throughout the pass.
...
\caption{Tactical, spatial, and speed evolution in Case~II. (a) The FSM
progresses from \textsc{Raceline} through \textsc{Shadow} to the committed
\textsc{Overtake} mode and retains the selected passing side through the
consecutive corners. (b) The actual ego trajectory remains inside the published
feasible corridor as it follows the varying physical track boundaries.
Triangles and squares mark the Encounter and Pass events, respectively. With
$\Delta s=s_o-s_e$ and $\Delta n=n_o-n_e$, the change from
$\Delta s_{\rm E}>0$ to $\Delta s_{\rm P}<0$ identifies the completed overtake,
while $|\Delta n_{\rm E}|$ and $|\Delta n_{\rm P}|$ give the corresponding
lateral separations. (c) The actual speed tracks the desired braking and
re-acceleration profile from an entry speed above 60~m~s$^{-1}$.}
...
Lateral, speed, and heading errors remain bounded about zero, with short
transients during the curvature and speed transitions. (d) All recorded
tangential--normal acceleration samples remain inside the speed-dependent tire
envelope over the recorded speed range.}
...
minimum net clearance between the vehicle body envelopes. PFR is the fraction
of planning cycles with a feasible SOCP solution. Bold denotes the best
observed value; equal track
